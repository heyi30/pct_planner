...
class Tomogram(object):
    ...
    def initBuffers(self):
        ...
        self.slice_heights = cp.zeros(self.n_slice_init, dtype=cp.float32)
    ...
    def initMappingEnv(self, center, map_dim_x, map_dim_y, n_slice_init, slice_h0):
        ...
        self.initBuffers()
        self.slice_heights = self.slice_h0 + cp.arange(self.n_slice_init, dtype=cp.float32) * self.slice_dh
        self.initKernel()
    ...
    def point2map(self, points):
        ...
        slice_heights = self.slice_heights[idx_simp].get()
        ...
        return layers_t, trav_gx, trav_gy, layers_g, layers_c, slice_heights, t_gpu